...
import 'kasir_dashboard_tab.dart';
...
class _KasirHomeScreenState extends ConsumerState<KasirHomeScreen> {
  ...
  late final List<Widget> _tabs = [
    KasirDashboardTab(onTabChange: (index) {
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomNavigationBar(
          ...
          items: const [
            ...
            BottomNavigationBarItem(icon: Icon(Icons.receipt_long_outlined), activeIcon: Icon(Icons.receipt_long_rounded), label: 'Transaksi'),
            BottomNavigationBarItem(icon: Icon(Icons.people_outline), activeIcon: Icon(Icons.people_rounded), label: 'Pelanggan'),
            BottomNavigationBarItem(icon: Icon(Icons.local_laundry_service_outlined), activeIcon: Icon(Icons.local_laundry_service_rounded), label: 'Layanan'),
          ],
        ),
      ),
    );
